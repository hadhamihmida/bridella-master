...
import '../widgets/role_selector_view.dart';
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          onPressed: () => Navigator.pushNamed(
              context, SignInScreen.routeName), // change to .pop
          ...
          DefaultButton(
            ...
            press: () {
              if (_formKey.currentState!.validate()) {
                ...
                showRoleSelectorSheet(context, email, password);
              }
            },
          ),
        ],
  ...
  TextFormField buildConformPassFormField() {
    return TextFormField(
      ...
      onChanged: (value) {
        ...
        } else if (value.isNotEmpty && password == confpassword) {
